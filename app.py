...
# ─────────────────────────────────────────────────────────────────────────────
# Demo Data (embedded CSV — no file paths needed for Streamlit Cloud)
# ─────────────────────────────────────────────────────────────────────────────

DEMO_CANDIDATES_CSV = """s_no,name,email,college,branch,cgpa,best_ai_project,research_work,github,resume,test_la,test_code
1,Student 1,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Engineering Physics,7,"Developed a CNN-based Leukemia Detection system during my Machine Learning Research Internship at DTU, focusing on automated classification of blood smear images. Implemented and compared deep learning architectures including VGG16, ResNet50, and InceptionV3 to analyze performance across precision, recall, and overall accuracy. Built an end-to-end pipeline covering image preprocessing, data augmentation, feature extraction, training, and evaluation using TensorFlow/Keras. Emphasized research-driven analysis through model benchmarking and optimization, aiming to improve diagnostic reliability and support early leukemia detection in clinical decision-making systems.","InViTNet — Hybrid Transformer–Convolution Vision-Language Model (Under Validation): Built a multi-branch medical imaging model combining ViT, CNN, RNN, and the Qwen-V3 Vision-Language model to fuse global attention, local spatial features, sequential patterns, and multimodal image–text understanding. Enhanced classification accuracy on BloodMNIST using cross-modal embeddings and transformer-based reasoning.",https://github.com/pranchalkumar001,https://drive.google.com/file/d/1VEOj44Qi5liZNS_ajILqbC-JMwza7Mic/view?usp=sharing,49,90
2,Student 2,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Electronics & Communication Engineering,6.6,"One of my best AI projects is a hybrid EEG-based Brain–Computer Interface for Motor Imagery classification using the BCI Competition IV 2a dataset. The system combines handcrafted features (FBCSP and Tangent Space) with deep features from EEGNet. EEGNet is pre-trained with data augmentation and fine-tuned per subject to reduce inter-subject variability. PCA-reduced embeddings, probabilistic outputs, and handcrafted features are fused into a meta-classifier (XGBoost, LightGBM, Logistic Regression). The model achieves 93.16% average accuracy, outperforming state-of-the-art methods.","Hybrid Feature Extraction Framework for Classification of Motor Imagery EEG Signals (Accepted, but not yet published)",https://github.com/Saurav2K03,https://drive.google.com/file/d/1DwmMFKXzBvlzEL5J439gGMoVQE5yiLnl/view?usp=drive_link,52,87
3,Student 3,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Computer Science and Engineering,8.22,"Developed an end-to-end deep learning system that converts spoken language video content into sign language, rendered through a realistic 3D avatar. The pipeline uses speech recognition for transcription, a Transformer-based sequence-to-sequence model trained on the How2Sign dataset (35,000+ sentence pairs) to generate human body keypoints (137 joints per frame), and a WebGL-powered 3D humanoid avatar with 67 articulated bones for real-time sign language animation. Built as a full-stack web application using React, Flask, and Three.js, making multimedia content accessible to the deaf community.",,,https://drive.google.com/file/d/1bx8x8VVeGn3HZvukCA1J9PL8sKKrklHk/view?usp=drive_link,59,68
4,Student 4,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Electrical Engineering,7.45,"My best AI project was an LLM powered Search Engine built during my internship at Address of Choice. I designed a RAG based architecture using LangChain and OpenAI APIs to enable intelligent, context aware real estate search. The system performed query understanding, semantic retrieval, and response generation over structured property data. I optimized inference cost and reduced latency for production deployment, while improving chat-based UX for better user engagement. The project combined NLP, vector search, and scalable API integration to deliver accurate, conversational property discovery.","Pragya Mishra, Md Saif, Rakshit Guar, Tushar Guar and Talabatula Srinivas Engineering Contrast in Coupled Resonance Induced Phenomena through Modified Nested Ring Resonators. Department of Electrical Communications Engineering, Indian Institute of Science (IISc), Bangalore, India. OPTIQ 2025, Accepted, Presented (To be Published).",https://github.com/saifahmed8521,https://drive.google.com/file/d/1HF6S0UVUcrmaVX3S1nBDUeIbX2TrBdVp/view?usp=drive_link,56,52
5,Student 5,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Electronics and Communication,7.71,"My standout AI project is an agentic AI virtual assistant and chatbot built for a SmartBank app to automate user financial workflows. I architected this system to deliver instant user value by providing high-fidelity, production-ready support. Handling the full product lifecycle alongside a small team, I integrated state-of-the-art AI models into a robust full-stack environment utilizing Prisma and SQL. The focus was on ensuring scalability, reliable outputs beyond just a demo, and an intuitive UI/UX. This hands-on experience building a workflow-native tool perfectly mirrors the high-velocity engineering required at Visl AI Labs.",,,https://drive.google.com/file/d/1muqBxNxCXaK1HAlCZPFk54gdQYlVkJ_M/view?usp=drive_link,52,81
6,Student 6,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Software Engineering,7.3,Implemented a Multimodal Cardiovascular Disease Prediction System using explainable AI (XAI) with LLM based clinical output,Manuscripts of research paper still being drafted,,https://drive.google.com/file/d/1m0_O9b2c9dnPSJnYeSDWoohCdlHT6m5n/view?usp=drive_link,68,53
7,Student 7,rishabh.choudhary+hatif@mynachiketa.com,Delhi Technological University,Mathematics and Computing,7.37,"This project investigates artifact exploitation in Indic fake news detection through a two-tier evaluation framework. Tier 0 compares BoW baselines against Transformers (mBERT, XLM-R) on curated Patil (0.99 Macro F1) vs. real-world BharatFakeNewsKosh (0.52 Macro F1) datasets, revealing BoW-Transformer convergence indicating surface pattern exploitation. Tier 1 cross-lingual transfer demonstrates catastrophic 46% F1 degradation, proving dataset-specific learning. Findings challenge benchmark progress narratives and advocate data-centric robustness evaluation for Indic NLP.","The pre-print versions of the paper are currently under processing. The latest draft can be found on github: https://github.com/Abhinandan132/Deceptive-Simplicity-High-F1-scores-due-to-artifact-obscuration-,,https://drive.google.com/file/d/14yNh3TeVPidzqVH2b2D9Yfi6GwU1FeSY/view?usp=drive_link,51,83
8,Student 8,rishabh.choudhary+hatif@mynachiketa.com,Netaji Subhas University of Technology,CSAI,6.5,"End-to-End Explainable IIoT Security with XAI Interpretations and Edge Deployment Optimization is a framework for detecting cyberattacks in Industrial IoT systems with transparency and efficiency. It uses multiple XAI techniques SHAP, Integrated Gradients, and DeepLIFT and applies a performance weighted XAI strategy to combine their explanations based on reliability. The system is optimized for edge deployment using pruning and FP16/INT8 quantization, significantly reducing model size and latency while preserving accuracy for real-time, trustworthy industrial security.","Adaptive Sand Cat Swarm Optimization Algorithm, End-to-End Explainable IIoT Security with XAI Interpretations and Edge Deployment Optimization (in progress)",https://github.com/YUVRAJ-SINGH-GANESHJI,https://drive.google.com/file/d/14Pf1wmbGW-exAKMIocTv-SulQeF2AnTy/view?usp=drive_link,70,90
9,Student 9,rishabh.choudhary+hatif@mynachiketa.com,netaji subhas university of technology,instrumentation and control,6.6,"My best AI project is a Multimodal Breast Cancer Risk Assessment System combining a Swin Transformer-based mammogram classifier with a weighted clinical risk modeling engine. I designed a structured fusion pipeline integrating imaging and tabular medical features for improved diagnostic stratification. The system includes real-time inference, confidence scoring, and an LLM-powered oncology assistant grounded in curated medical literature using a retrieval layer. Deployed using Next.js and Flask, it simulates a production-ready AI-assisted clinical decision support system.","Anurag Singh, Aryan Singh, Ayush Singh, et al. Multimodal Breast Cancer Risk Assessment using Vision Transformers and Clinical Feature Fusion. Manuscript submitted for publication (under review).",https://github.com/anvragsingh,https://drive.google.com/file/d/1Jnv-kxuoyomQJUlxEBW2Es4iQuhfNuuj/view?usp=drive_link,51,71
